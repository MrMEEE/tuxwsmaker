    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("group_base_dn", models.CharField(blank=True, max_length=255)),
                (
                    "group_membership",
                    models.CharField(
                        choices=[
                            ("ad", "Active Directory memberOf"),
                            ("posix", "POSIX memberUid"),
                        ],
                        default="ad",
                        max_length=16,
                    ),
                ...
                (
                    "attr_first_name",
                    models.CharField(default="givenName", max_length=64),
                ),
